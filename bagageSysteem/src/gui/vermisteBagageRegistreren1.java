...
public class vermisteBagageRegistreren1 extends javax.swing.JFrame {
    ...
    int taal;
    int rechten;
    public vermisteBagageRegistreren1(int taal, int rechten) {
    ...
    private void btnDoorgaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoorgaanActionPerformed
        try {
            ...
            klantenDatabase klant = new klantenDatabase();
            
            int klantId = 1;
            klant.InsertVermist(klantId);
            ...
            Logger.getLogger(vermisteBagageRegistreren1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vermisteBagageRegistreren1(0, 0).setVisible(true);
            }
        });
    }

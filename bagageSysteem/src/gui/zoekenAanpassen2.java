...
int taal;
int rechten;
    public zoekenAanpassen2(int taal, int rechten) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 120, 250, -1));
        jTextField5.getAccessibleContext().setAccessibleName("");

        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 210, 250, -1));
        getContentPane().add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 180, 250, -1));
        getContentPane().add(jTextField12, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 350, 250, -1));
        getContentPane().add(jTextField13, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 320, 250, -1));
        getContentPane().add(jTextField14, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 290, 250, -1));

        persoonsgegevensTekst.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        persoonsgegevensTekst.setText("Persoonsgegevens");
        getContentPane().add(persoonsgegevensTekst, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, -1, -1));

        naamTekst.setText("Naam");
        getContentPane().add(naamTekst, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, -1, -1));

        geboortedatumTekst.setText("Geboortedatum");
        getContentPane().add(geboortedatumTekst, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 150, -1, -1));

        telefoonnummerTekst.setText("Telefoonnummer");
        getContentPane().add(telefoonnummerTekst, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 180, -1, -1));

        emailTekst.setText("E-mail");
        getContentPane().add(emailTekst, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 210, -1, -1));

        verzendenNaarTekst.setText("Verzenden naar");
        getContentPane().add(verzendenNaarTekst, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 240, -1, -1));

        adresTekst.setText("Adres");
        getContentPane().add(adresTekst, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 260, -1, -1));

        woonplaatsTekst.setText("Woonplaats");
        getContentPane().add(woonplaatsTekst, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 290, -1, -1));
        getContentPane().add(postcodeTekstveld, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 260, 250, -1));

        postcodeTekst.setText("Postcode");
        getContentPane().add(postcodeTekst, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 320, -1, -1));

        landTekst.setText("Land");
        getContentPane().add(landTekst, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 350, -1, -1));

        locatieVermistOpgegevenTekst.setText("Locatie gevonden");
        getContentPane().add(locatieVermistOpgegevenTekst, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 380, -1, -1));
        getContentPane().add(jTextField15, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 380, 250, -1));

        locatieVermistOpgegevenTekst1.setText("Gevonden gemeld");
        getContentPane().add(locatieVermistOpgegevenTekst1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 410, -1, -1));
        getContentPane().add(jTextField16, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 410, 250, -1));
    ...
    private void annulerenKnopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_annulerenKnopActionPerformed
        ...
        zoekenAanpassen1 m = new zoekenAanpassen1(taal, rechten);
        zoekenAanpassen1.ingelogdAlsTekst.setText(ingelogdAlsTekst.getText());
        m.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new zoekenAanpassen2(0, 0).setVisible(true);
            }
        });
    }
